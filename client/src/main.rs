...
use gateway::auth_client::AuthClientFactory;
use gateway::auth_client::AuthenticatorFactory;
use gateway::auth_client::ClientSession;
use gateway::proxy_client::proxy::CommandResponse;
use command::Command;
